...
namespace SystemBrightSpotBE.Dtos.User
{
    public class AddUserDto
    {
        ...
        [MaxLength(64, ErrorMessageResourceType = typeof(UserResource), ErrorMessageResourceName = "EmailMaxLength")]
        [RegularExpression(@"^[\w\.\-]+@([\w\-]+\.)+[a-zA-Z]{2,4}$",
            ErrorMessageResourceType = typeof(UserResource), ErrorMessageResourceName = "EmailRegx")]
        // [EmailAddress(ErrorMessageResourceType = typeof(UserResource), ErrorMessageResourceName = "EmailRegx")]
        ...
        [NotMapped]
        public List<StatusHistoryDto> status_history { get; set; } = new();
